...
VIM_SUB_FILES := map.vim color.vim plugin.vim dein.toml unite.toml ddu.toml gui.vim misc.vim

NVIM_DIR := ~/.config/nvim
NVIM_PLUGIN_DIR := ~/.cache/dein
NVIM_FILES := init.vim ginit.vim map.vim color.vim plugin.vim dein.toml unite.toml ddu.toml gui.vim misc.vim
