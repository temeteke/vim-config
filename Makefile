...
VIM_SUB_FILES := map.vim color.vim plugin.vim plugin_dein.toml plugin_dein_lazy.toml plugin_dein_nodenops.toml plugin_dein_denops.toml gui.vim misc.vim

NVIM_DIR := ~/.config/nvim
NVIM_PLUGIN_DIR := ~/.cache/dein
NVIM_FILES := init.vim ginit.vim map.vim color.vim plugin.vim plugin_dein.toml plugin_dein_lazy.toml plugin_dein_nodenops.toml plugin_dein_denops.toml gui.vim misc.vim
